 ...
 * @version $Id: ircd_features.c 1948 2010-07-05 21:28:54Z klmitch $
 */
#include "config.h"
...
static struct FeatureDesc {
  ...
  F_S(HIS_SERVERNAME, 0, "servers.virtuanet.org", feature_notify_servername),
  F_S(HIS_SERVERINFO, 0, "Virtuanet IRC Network", feature_notify_serverinfo),
  F_S(HIS_URLSERVERS, 0, "http://virtuanet.org/servers", 0),

  /* Misc. random stuff */
  F_S(NETWORK, 0, "Virtuanet", 0),
  F_S(URL_CLIENTS, 0, "http://www.irc.org/links.html", 0),
  F_S(URLREG, 0, "http://virtuanet.org/register", 0),
